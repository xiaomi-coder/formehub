...
bool CGlobals::Update()
{
	...
	std::call_once(flag, []()
	{
		// Default latest fallback offsets (a2x/cs2-dumper — build 14178, 2026-08-27)
		std::uintptr_t uEntityList = 39260720;
		...
		std::uintptr_t uCSGOInput = 37600384;
		std::uintptr_t uNetworkGameClient = 9491632;
		std::uintptr_t uEntitySystem = 39260720;
